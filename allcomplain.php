...
<div class="profile_left">
    ...
    <div class="profile_info">
        ...
        <div class="profile_buttons">
            <button onclick="window.location.href = '/ComplainBox/adddepartment.php';" class="profile_complain_button">
                Add Department
            </button>
            <button class="profile_complain_button" onclick="window.location.href = '/ComplainBox/admindashboard.php';">
                Complain
            </button>
            <button class="profile_complain_button " onclick="window.location.href = '/ComplainBox/allcomplain.php'">
                View All Complain
            </button>
