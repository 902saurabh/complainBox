...
$sql = "SELECT * FROM user WHERE email like '%" . $_SESSION['email'] . "%';";
...
$sql = "SELECT usertype FROM user WHERE email like '%" . $_SESSION["email"] . "%'";
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="username" class="form-control center"
