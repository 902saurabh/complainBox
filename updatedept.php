                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="edeptname" name="departmentname"
                                                       autocomplete="off" value="<?php echo $deptname; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="edeptpass" name="passwrd"
                                                       value="<?php echo $deptpasswd; ?>" class="form-control">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="mail" id="edept" name="heademail"
                                                       value="<?php echo $deptmail; ?>" class="form-control">
                                            </div>
                                        </div>
                                    </div>
