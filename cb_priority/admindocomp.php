                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats" style="box-shadow:none;">
                            ...
                            <div class="card-footer">
                                <div class="stats">
                                    <a href="./adminmycomplain.php?status=">View Details</a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card card-stats" style="box-shadow:none;">
                            ...
                            <div class="card-footer">
                                <div class="stats"><a href="./adminmycomplain.php?status=In-Progress">View Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form action="" enctype="multipart/form-data" style="margin-top: -40px;" method="POST">
									...
									<div class="custom-control custom-radio">
										<input type="radio" name="radio" id="customRadio1" class="custom-control-input" value="minor">
										<label class="custom-control-label" style="
									color: black;" for="customRadio1" required>Minor</label>
									  </div>
									  
									  <div class="custom-control custom-radio">
										<input type="radio" name="radio" id="customRadio2" class="custom-control-input" value="moderate">
										<label class="custom-control-label" style="
									color: black;" for="customRadio2" required>Moderate</label>
									  </div>
									  
									  <div class="custom-control custom-radio">
										<input type="radio" name="radio" id="customRadio3" class="custom-control-input" value="critical">
										<label class="custom-control-label" style="
